...
In order to support loading of multiple wallets in eps-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eps.cpp.
...
Changes to eps.cpp
----------------------
eps.cpp is the entry point into eps-qt, and as such, will require some minor modifications to provide hooks for
