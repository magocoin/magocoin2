...
The Eps project operates an open contributor model where anyone is
...
The following applies to code changes to the Eps project, and is not to be
confused with overall EPS Network Protocol consensus changes.

Whether a pull request is merged into Eps rests with the project merge
...
Patches that change EPS consensus rules are considerably more involved than
...
Where a patch set proposes to change the EPS consensus, it must have been
...
The project leader is the release manager for each Eps release.
