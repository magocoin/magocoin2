Contributing to Magocoin
============================

The Magocoin project operates an open contributor model where anyone is
...
The following applies to code changes to the Magocoin project, and is not to be
confused with overall magocoin Network Protocol consensus changes.

Whether a pull request is merged into Magocoin rests with the project merge
...
The project leader is the release manager for each Magocoin release.
