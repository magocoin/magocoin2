...
This means one can have an always-on magocoind instance running, and another local magocoind/magocoin-qt instance which connects to this node and receives blocks from it.
