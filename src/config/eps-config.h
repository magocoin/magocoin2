/* src/config/eps-config.h.  Generated from eps-config.h.in by configure.  */
/* src/config/eps-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "eclipsead.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eps Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eps Core 1.0.0"
