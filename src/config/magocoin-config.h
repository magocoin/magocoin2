/* src/config/magocoin-config.h.  Generated from magocoin-config.h.in by configure.  */
/* src/config/magocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Magocoin_CONFIG_H

#define Magocoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "magocoinad.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Magocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Magocoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "magocoin"
