...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EPS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eps: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Eps"), this);
    aboutAction->setStatusTip(tr("Show information about Eps"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EPS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EPS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EPS addresses"));
    ...
    openAction->setStatusTip(tr("Open a EPS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Eps help message to get a list with possible EPS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Eps client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EPS network", "", count));
}
...
{
    QString strTitle = tr("Eps"); // default title
