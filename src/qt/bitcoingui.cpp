                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Magocoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Magocoin"), this);
    aboutAction->setStatusTip(tr("Show information about Magocoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Magocoin help message to get a list with possible magocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Magocoin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Magocoin"); // default title
